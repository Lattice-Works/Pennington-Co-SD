...
//        final ManualPSAIntegrationConfiguration config = CONFIGURATIONS.get( County.pennington );
        ...
        Flight psaFlight = Flight.newFlight()
                ...
                .addEntity( IntegrationAliases.PSA_RISK_FACTORS_ALIAS )
                    ...
                    .addProperty( EdmConstants.PRIOR_V_CONVICTION_FQN , IntegrationAliases.PRIOR_VIOLENT_COLUMN )
                    .addProperty( EdmConstants.RECENT_FTA_FQN , IntegrationAliases.RECENT_FTA_COLUMN )
...
//                    .addProperty( EdmConstants.CONTEXT_FQN ).value( row -> String.format( "Court (%s)", County.pennington )).ok()
                    .addProperty( EdmConstants.CURRENT_V_OFFENSE_FQN , IntegrationAliases.CURRENT_VIOLENT_OFFENSE_COLUMN )
                    .addProperty( EdmConstants.AGE_AT_ARREST_FQN , IntegrationAliases.AGE_AT_ARREST_COLUMN )
